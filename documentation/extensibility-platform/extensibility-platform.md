...
Cloud Director provides an [Object Extensibility](object-extensibility.md) feature that allows Extensions to participate in, influence, or override the logic that VMware Cloud Director applies
